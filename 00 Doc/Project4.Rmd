...
For this project, we looked at the Evnironmentel Protection Agency's [fuel economy data](https://www.fueleconomy.gov/feg/download.shtml) for every vehicle tested at the National Vehicle and Fuel Emissions Laboratory in Ann Arbor, Michigan since 1984. This dataset has data on almost 37,000 different vehicles, and includes many attributes to analyze. 

## Summary of the data frame used
We used a subset of the attributes to conduct our analysis. Here is the first ten rows of the data frame that powers all of our plots:
...
These two plots, the first done in Tableau and the second one done using ggplot2 in R studio, look at how what transmission type the car has produces the best highway and city MPG. Our first impression was that a manual transmission would produce the best MPG, but we were surprised to learn that an automatic 6-speed transmission produces not only the highest city MPG but also the highest highway MPG. Doing some [further research](http://www.edmunds.com/fuel-economy/five-myths-about-stick-shifts.html) found that manual transmissions used to be more fuel efficent, but because of recent advances in automatic transmission technology, automatic transmissions have started to become more efficient in some cases.
...
These next two plots, the first done in Tableau and the second one done using ggplot2 in R studio, looks at how the combined MPG of all cars since 1984 has evolved over the years. This plot was created to see if a trend was present. Initially, we were fairly confident that a positive trend would be present due to the recent advances in EV technology and general improvements in the efficency of internal combustion engines.

However, what we were surprised to find was how drastic and inconsistant the trend was. From 1984 to about 1998, no car that the EPA tested ever got above a combined MPG rating of 50, resutling in a relatively flat trend. Then from 1998 to 2003, you get numerous vehicles getting above the 50 MPG mark, resulting in a very steep positive trend for those years. From 2003 to just before 2010, you get all but one vehicle getting less than 55 MPG, so you get a very steep decline and then flat trend for that time period. From 2010 onward, a steep positive trend emerges again as the number of vehicles above the 55 MPG mark explodes.  
...
## Plot 5 and 6: Cross tab of top 20 vehicle manufacturers and the MPG to passenger volumn ratio for 2 door cars since 1984
These next two plots, the first done in Tableau and the second one done using ggplot2 in R studio, provide a visual representation of which vehicle manufactures produced two door cars that were efficent (high combined MPG) and spacious (as measured by the passenger volumn of the vehicle). Plots 7 and 8 look at 4 door cars since 1984. To calculate the ratio used for the KPI, we summed up the combined MPG of all the 2 door vehicles that a manufacturer produced during a model year and divided that by the total passenger volumn for all those 2 door vehicles. The KPI categories are as follows: 

* Efficient and Spacious (KPI value > 2) - a manufacturer acheives this designation by offering a portfolio of 2 door cars that has a high combined MPG rating relative to the total passenger volumn
* Average Efficeny and Space (1 <= KPI value < 2) - a manufacturer acheives this designation by offering a portfolio of 2 door cars that has a combined MPG rating relatively equal to the total passenger volumn
* Not Efficient and Spacious - (KPI value < 1) a manufacturer acheives this designation by offering a portfolio of 2 door cars that has a low combined MPG relative to the total passenger volumn

The interesting takaway from this graph is that it visually represents a car comapnys' 2 door vehicle portfolio in terms of how efficent those cars are relative to how much passenger volumn it has (which, for the purposes of our analysis, is used as a proxy for the size of the vehicle). It also shows that some car companies, like Chevy and Ford, have generally improved the efficency of their vehicles relative to how large the car is. There are also other companies, like Honda, that have newer vehicles achieving much worse efficieny to size ratios than the later models. 
...
## Plot 7 and 8: Cross tab of top 20 vehicle manufacturers and the MPG to passenger volumn ratio for 4 door cars since 1984
These next two plots, the first done in Tableau and the second one done using ggplot2 in R studio, provide a visual representation of which vehicle manufactures produced four door cars that were efficent (high combined MPG) and spacious (as measured by the passenger volumn of the vehicle). To calculate the ratio used for the KPI, we summed up the combined MPG of all the 4 door vehicles that a manufacturer produced during a model year and divided that by the total passenger volumn for all those 4 door vehicles. The KPI categories are as follows: 

* Efficient and Spacious (KPI value > 2) - a manufacturer acheives this designation by offering a portfolio of 4 door cars that has a high combined MPG rating relative to the total passenger volumn
* Average Efficeny and Space (1 <= KPI value < 2) - a manufacturer acheives this designation by offering a portfolio of 4 door cars that has a combined MPG rating relatively equal to the total passenger volumn
* Not Efficient and Spacious - (KPI value < 1) a manufacturer acheives this designation by offering a portfolio of 4 door cars that has a low combined MPG relative to the total passenger volumn

The interesting takaway from this graph is that it visually represents a car comapnys' 4 door vehicle portfolio in terms of how efficent those cars are relative to how much passenger volumn it has (which, for the purposes of our analysis, is used as a proxy for the size of the vehicle).
